...
function createRecipe(recipeName, img_url, video_url, description, countryTag, rating, cookTime, yields, ingredientsTag, instructionsTag, nutrition, difficultyTag) {
  if (loadingModal) {
    loadingModal.remove();
